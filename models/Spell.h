...
class Spell
{
  public:
     ...
     */
    explicit Spell(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Spell(const Json::Value &pJson) noexcept(false);
     ...
     */
    Spell(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    const int16_t &getValueOfLevel() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int16_t> &getLevel() const noexcept;
    ///Set the value of the column Level
    void setLevel(const int16_t &pLevel) noexcept;
  ...
  private:
    friend drogon::orm::Mapper<Spell>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Spell>;
#endif
